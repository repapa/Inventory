...
│   ├── setup                 # Scripts for setting up a new project
...
Using the `npm run test:cover` command to run the tests, building a code coverage report. The report is written to `coverage/index.html`. Script:
